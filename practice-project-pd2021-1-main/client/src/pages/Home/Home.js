...
import WhyASqu from '../../components/WhyASqu/WhyASqu'
        ...
        <>
          <div className={styles.container}>
            ...
            <div className={styles.container__description}>
              ...
              <WhyASqu imgSrc={`${CONSTANTS.STATIC_IMAGES_PATH}more-benifits-world-icon.png`} title={'Largest Naming Community'} text={'Our unique approach to company naming services allows you to receive an unmatched breadth of business name ideas from the world`s largest community of naming experts. With 200,000+ creatives and 30,000+ successful naming projects, Squadhelp is by far the largest naming platform across the globe.'}
              <WhyASqu imgSrc={`${CONSTANTS.STATIC_IMAGES_PATH}more-benifits-high-quality-icon.png`} title={'High Quality & Collaboration'} text={'Using an advanced Quality Scoring Algorithm and Machine Learning, we ensure that you receive more ideas from our top-quality creatives, and Gamification best practices ensure two-way communication throughout your contest.'}
              <WhyASqu imgSrc={`${CONSTANTS.STATIC_IMAGES_PATH}more-benifits-trademark-icon.png`} title={'Naming Agency-Level Features'} text={'Squadhelp`s high end Audience Testing service allows you to poll your target demographics to get unbiased feedback on your favorite names. Also receive Trademark support from our team of Licensed Trademark Attorneys, so you can pick your name with confidence.'}
            </div>
            <div className={styles.greyContainer}>
